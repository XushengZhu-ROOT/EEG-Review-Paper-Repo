...
chan=30
CUDA_VISIBLE_DEVICES=0 python run_class_finetuning.py \
     --output_dir ./checkpoints/finetune_stress_noleak_${chan}chan_no400up_seed_siwen42-4review-cbramod3lyclassifier \
     --log_dir ./log/finetune_stress_noleak_${chan}chan_no400up_seed_siwen42-4review-cbramod3lyclassifier \
     --dataset_path augmented_data/Stress_noleak_${chan}chan_no400up_seed_siwen42 \
     --channel_size ${chan} \
     --finetune ./checkpoints/labram-base.pth \
