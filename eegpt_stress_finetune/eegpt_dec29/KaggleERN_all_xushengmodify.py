...
class Config:
    ...
    # Saving
    output_dir: str = "./20251225_output/eegpt_all"
...
class EEGPTStressClassifier(nn.Module):
    ...
    Match EEGPT official finetuning:
      ...
      - MLP Head: Layer1(N×embed_num×embed_dim->N×embed_dim), Layer2(N×embed_dim->embed_dim), Layer3(embed_dim->2)
    """
    def __init__(self, cfg: Config, detected_in_channels: int):
        ...
        #    Layer 3: embed_dim -> num_classes (2 for binary classification)
        ...
        self.classifier = nn.Sequential(
            ...
            nn.Linear(self.cfg.embed_dim, 2)  # 2 classes for binary classification
        )
