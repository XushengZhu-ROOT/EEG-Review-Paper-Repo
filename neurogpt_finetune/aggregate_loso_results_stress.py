...
src/train_gpt.py's save_loso_fold_results().
...
Usage:
  ...
  python3 aggregate_loso_results_stress.py --fold_results_dir ./fold_results_neurogpt_stress --task stress --model neurogpt --out loso_results_neurogpt_stress.csv
"""
import argparse
import csv
import glob
...
def main():
    ...
    parser.add_argument("--fold_results_dir", type=str, default="./fold_results_neurogpt_stress")
    parser.add_argument("--task", type=str, default="stress")
    parser.add_argument("--model", type=str, default="neurogpt")
    parser.add_argument("--out", type=str, default="loso_results_neurogpt_stress.csv")
    parser.add_argument("--cm_out", type=str, default="loso_confusion_matrix_neurogpt_stress.npy")
