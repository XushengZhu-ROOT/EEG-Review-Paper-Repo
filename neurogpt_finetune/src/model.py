...
class Model(torch.nn.Module):
    ...
    def from_pretrained(
        self, pretrained_path: str, keys_to_ignore: Optional[List[str]] = None
    ) -> None:
        """Load pretrained model from pretrained_path.
        Needs to point to pytorch_model.bin file.
        """
    ...
    def switch_decoding_mode(
        ...
        self.embedder.switch_decoding_mode(
            is_decoding_mode=is_decoding_mode, num_decoding_classes=num_decoding_classes
        )
    ...
    def compute_loss(
        self, batch: Dict[str, torch.tensor], return_outputs: bool = False
