...
"""
from batcher.downstream_dataset import MotorImageryDataset, KaggleERNDataset
import torch
import os
import glob
import argparse
...
def get_args() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        choices=("eval_validation_loss", "eval_validation_acc", "eval_validation_bacc"),
        type=str,
