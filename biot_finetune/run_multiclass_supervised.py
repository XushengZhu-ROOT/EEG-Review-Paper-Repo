...
from utils import ISRUCLoader, KaggleERNLoader, TUABLoader, CHBMITLoader, PTBLoader, focal_loss, BCE
...
def prepare_ISRUC_dataloader(args):
    # set random seed
    seed = 12345
    ...
    train_loader = torch.utils.data.DataLoader(
        ISRUCLoader(os.path.join(root, "train"),
    ...
    test_loader = torch.utils.data.DataLoader(
        ISRUCLoader(os.path.join(root, "test"), test_files, args.sampling_rate),
        batch_size=args.batch_size,
        shuffle=False,
        num_workers=args.num_workers,
        persistent_workers=True,
    ...
    val_loader = torch.utils.data.DataLoader(
        ISRUCLoader(os.path.join(root, "val"), val_files, args.sampling_rate),
        batch_size=args.batch_size,
        shuffle=False,
        num_workers=args.num_workers,
        persistent_workers=True,
...
def supervised(args):
    ...
    if args.dataset == "TUEV":
        ...
        train_loader, test_loader, val_loader = prepare_ISRUC_dataloader(args)
    else:
