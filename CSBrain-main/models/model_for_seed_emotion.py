...
class Model(nn.Module):
    def __init__(self, param):
        ...
        if param.model == 'CSBrain':
            ...
            raise ValueError(f"Unsupported model: {param.model}")
        ...
        # 使用三个MLP的分类器头（仿照cbramod中的all_patch_reps分类器）
        # 三个MLP：Linear -> ELU -> Dropout -> Linear -> ELU -> Dropout -> Linear
    ...
    def forward(self, x):
        ...
        # Reshape features: (bz, ch_num, seq_len, patch_size) -> (bz, ch_num * seq_len * patch_size)
