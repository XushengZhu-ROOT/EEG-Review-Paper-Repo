...
from datasets import tusl_dataset, siena_dataset, hmc_dataset, seed_emotion_dataset
...
from models import model_for_siena, model_for_hmc,model_for_stress,model_for_mumtaz, model_for_seed_emotion
...
def main():
    ...
    parser.add_argument('--downstream_dataset', type=str, default='FACED',
                        help='[FACED, SEED-V, PhysioNet-MI, SHU-MI, ISRUC, CHB-MIT, BCIC2020-3, Mumtaz2016, SEED-VIG, MentalArithmetic, TUEV, TUAB, BCIC-IV-2a, SEED-Emotion]')
    ...
    parser.add_argument('--channel_size', type=int, default=62, help='channel size, for classifier')
    parser.add_argument('--window_size', type=int, default=4, help='window size, for classifier')
    """############ Downstream dataset settings ############"""
    ...
    parser.add_argument('--frozen', action='store_true',
                        help='Freeze the backbone (linear probe)')
