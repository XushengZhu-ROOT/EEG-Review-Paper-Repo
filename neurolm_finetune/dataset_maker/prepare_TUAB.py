...
if __name__ == "__main__":
    ...
    root = "/work/HHRI-AI/UCSD_EEG/eeg_data/EEG_data/EEGPT_Data/tuh_eeg_abnormal/tuh_eeg_abnormal/v3.0.0/edf"
    ...
    if not os.path.exists(os.path.join(save_dir, "processed", "train")):
        os.makedirs(os.path.join(save_dir, "processed", "train"))
    train_dump_folder = os.path.join(save_dir, "processed", "train")

    if not os.path.exists(os.path.join(save_dir, "processed", "val")):
        os.makedirs(os.path.join(save_dir, "processed", "val"))
    val_dump_folder = os.path.join(save_dir, "processed", "val")

    if not os.path.exists(os.path.join(save_dir, "processed", "test")):
        os.makedirs(os.path.join(save_dir, "processed", "test"))
    test_dump_folder = os.path.join(save_dir, "processed", "test")
